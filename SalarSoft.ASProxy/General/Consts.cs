...
namespace SalarSoft.ASProxy
{
	...
	public class Consts
	{
		...
		public class General
		{
			...
			public const string ASProxyVersionFull = "5.5.0.7";
		...
		public class FilesConsts
		{
			...
			public static readonly string Dir_Plugins = Dir_AppData + Path.DirectorySeparatorChar + "Plugins";
			public static readonly string Dir_Providers = Dir_AppData + Path.DirectorySeparatorChar + "Providers";
			public static readonly string Dir_Updater = Dir_AppData + Path.DirectorySeparatorChar + "Updater";
