    ...
    <fieldset>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="chkLoginEnabled" runat="server" Text="Login is Required" 
                        Enabled="False" />
                    <asp:Button ID="btnLoginEnable" runat="server" Text="Enable" 
                        style="padding:0px; margin:0px; font-size:x-small;" 
                        onclick="btnLoginEnable_Click" />/<asp:Button ID="btnLoginDisable" 
            ...
            <tr>
                ...
                <td>
                    <fieldset>
                        <legend>New ASProxy user</legend>
                        <span class="field_desc">(Specify users who can access to ASProxy. Also you can specify user limitations.)</span>
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    Username:
            ...
            <tr>
                ...
                <td>
                    ...
                    <br /><span class="field_desc">(You can delete the users from here. Note that at 
                    least one user should be there to this feature work properly.)</span>
                    <br />
                    <asp:Button ID="btnDeleteUser" CssClass="submit_button" runat="server" 
                        Text="Delete" onclick="btnDeleteUser_Click" />
        ...
        <table style="width: 100%;">
                ...
                <td>
                    <fieldset>
                        ...
                        <table style="width: 100%;">
                            ...
                            <td>Rule mode:</td>
                            <td>
                                    <asp:RadioButton ID="rbtnUacAllow" runat="server" Text="Allow the address(es)" 
                                    GroupName="RuleMode" Checked="True" />
                                    <br />
                                    <asp:RadioButton ID="rbtnUacBlock" runat="server" Text="Block the address(es)" 
                                    GroupName="RuleMode" />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButton ID="rbtnUacAddIP" runat="server" Text="Single IP" 
                                        GroupName="Range" Checked="True" />
                                </td>
                                <td>
                                    IP Address:<br />
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnUacAddRule" CssClass="submit_button" runat="server" 
                                        Text="Add Rule" onclick="btnUacAddRule_Click" />
                                    
                                </td>
                                <td>
                                    <b>Note:</b> If you specify an allow rule, all the block rules will be ignored!</td>
                            </tr>
                        </table>
                    </fieldset>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br /><span class="field_desc">(You can delete rules from here.)</span>
                    <br />
                    <asp:Button CssClass="submit_button" ID="btnUACDelete" runat="server" 
                        Text="Delete" onclick="btnUACDelete_Click" />
