...
// Last update: 2009-07-24 coded by Salar Khalilzadeh //
...
toGetCName=_reqInfo.cookieName;var cookieString=document.cookie;if(typeof(_ASProxy.TraceCookies)!='undefined'&&_ASProxy.TraceCookies)
_ASProxy.Log("__CookieGet: "+_CookieName);var aCookie=cookieString.split("; ");for(var i=0;i<aCookie.length;i++)
{var aCrumb=aCookie[i].split("=");if(toGetCName==aCrumb[0])
return unescape(aCrumb[1]);}
return"";}
function __CookieSet(sCookie){var cookieSettingValues="";if(typeof(_ASProxy.TraceCookies)!='undefined'&&_ASProxy.TraceCookies)
_ASProxy.Log("__CookieSet: "+sCookie);function GetCookie(cookieString,sName){var aCookie=cookieString.split("; ");for(var i=0;i<aCookie.length;i++)
