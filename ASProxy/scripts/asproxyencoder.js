...
// asproxy pages url. all in lowercase
...
_ASProxy.pgDownload='download.ashx';
...
function ASProxyEncoder(url,type,addFormMethod,formMethod,notCorrectLocalUrl){
	...
	asproxyBasePath+='?dec='+__ASProxyEncodeUrl+'&url=';
	var bookmark;
	var result;
...
_ASProxy.EncodedUrls=new Array(__ASProxyDefaultPage+"?dec=",_ASProxy.pgImages+"?dec="
    ,_ASProxy.pgGetJS+"?dec=",_ASProxy.pgGetCss+"?dec=",_ASProxy.pgGetHtml+"?dec="
    ,_ASProxy.pgDownload+"?dec=",_ASProxy.pgAuthorization+"?dec=",_ASProxy.pgGetAny+"?dec=");
