...
return requestUrl;return _ASProxy.CorrectLocalUrlToOrginal(url);}
...
if(o.addEventListener){o.addEventListener(evType,f,capture);return true;}else if(o.attachEvent){var r=o.attachEvent("on"+evType,f);return r;}else{try{o["on"+evType]=f;}catch(e){}}}catch(e){}}
...
_ASProxy.Enc.EncodeFrames=function(){if(_userConfig.Frames!=true)return;var frames=document.documentElement.getElementsByTagName("iframe");try{_ASProxy.Enc.EncodeElements(frames,"src",3,false,null,null,"onload","_ASProxy.Enc.EncodeFrames()");}catch(e){}
window.setTimeout("_ASProxy.Enc.EncodeFrames();",5000);}
_ASProxy.Enc.EncodeLinks=function(){if(_userConfig.Links!=true)return;try{_ASProxy.Enc.EncodeElements(document.links,"href",0,true);}catch(e){}
window.setTimeout("_ASProxy.Enc.EncodeLinks();",1000);}
_ASProxy.Enc.EncodeImages=function(){if(_userConfig.Images!=true)return;try{_ASProxy.Enc.EncodeElements(document.images,"src",1,true);}catch(e){}
window.setTimeout("_ASProxy.Enc.EncodeImages();",1000);}
_ASProxy.Enc.EncodeInputImages=function(){if(_userConfig.Images!=true)return;var inputImages=document.documentElement.getElementsByTagName("input");try{_ASProxy.Enc.EncodeElements(inputImages,"src",1,true,"type","image");}catch(e){}
window.setTimeout("_ASProxy.Enc.EncodeInputImages();",4000);}
_ASProxy.Enc.EncodeScriptSources=function(){var scripts=document.documentElement.getElementsByTagName("script");try{_ASProxy.Enc.EncodeElements(scripts,"src",2,false);}catch(e){}
window.setTimeout("_ASProxy.Enc.EncodeScriptSources();",4000);}
_ASProxy.LocationObject=function(){this.search=_reqInfo.location.Search;this.href=_reqInfo.pageUrl;this.hash=(window.location.hash!=null&&window.location.hash!='')?window.location.hash:_reqInfo.location.Hash;this.host=_reqInfo.location.Host;this.hostname=_reqInfo.location.Hostname;this.pathname=_reqInfo.location.Pathname;this.port=_reqInfo.location.Port;this.protocol=_reqInfo.location.Protocol;this.replace=window.LocationReplace;this.assign=window.LocationAssign;this.URL=_reqInfo.pageUrl;this.toString=function(){return _reqInfo.pageUrl;};this.toLocaleString=function(){return _reqInfo.pageUrl;};this.length=this.href.length;this.anchor=this.href.anchor;this.big=this.href.big;this.blink=this.href.blink;this.bold=this.href.bold;this.charAt=this.href.charAt;this.charCodeAt=this.href.charCodeAt;this.fixed=this.href.fixed;this.fontcolor=this.href.fontcolor;this.fontsize=this.href.fontsize;this.fromCharCode=this.href.fromCharCode;this.indexOf=this.href.indexOf;this.italics=this.href.italics;this.lastIndexOf=this.href.lastIndexOf;this.link=this.href.link;this.match=this.href.match;this.slice=this.href.slice;this.small=this.href.small;this.split=this.href.split;this.strike=this.href.strike;this.sub=this.href.sub;this.substr=this.href.substr;this.substring=this.href.substring;this.toLowerCase=this.href.toLowerCase;this.toUpperCase=this.href.toUpperCase;};function __CookieGet(_CookieName){var toGetCName=_CookieName;if(toGetCName==null)
toGetCName=_reqInfo.cookieName;var cookieString=document.cookie;var aCookie=cookieString.split("; ");for(var i=0;i<aCookie.length;i++)
{var aCrumb=aCookie[i].split("=");if(toGetCName==aCrumb[0])
return unescape(aCrumb[1]);}
return"";}
function __CookieSet(sCookie){var cookieSettingValues="";function GetCookie(cookieString,sName){var aCookie=cookieString.split("; ");for(var i=0;i<aCookie.length;i++)
{var aCrumb=aCookie[i].split("=");if(sName==aCrumb[0])
return unescape(aCrumb[1]);}
return null;}
function EscapeCookie(value){return _reqInfo.cookieName+"="+escape(value)+"; path=/;"+cookieSettingValues;}
function JoinCookies(preCookie,newCookie){cookieSettingValues="";var aPreCookie=preCookie.split("; ");var aNewCookie=newCookie.split("; ");var resultCookie="";var tempColl=new Array();for(var i=0;i<aPreCookie.length;i++)
{var preCrumb=aPreCookie[i].split("=");var preName=preCrumb[0];if(preName=="")continue;if(preName=="expires"||preName=="secure")
{cookieSettingValues+=aPreCookie[i]+"; ";continue;}
var exists=false;for(var newI=0;newI<aNewCookie.length;newI++)
{var newCrumb=aNewCookie[newI].split("=");var newName=newCrumb[0];if(preName==newName)
{exists=true;break;}}
if(exists==false)
...
cookieSettingValues="; "+cookieSettingValues;return resultCookie;}
var previousCookie=GetCookie(document.cookie,_reqInfo.cookieName);if(previousCookie!=""&&previousCookie!=null)
previousCookie=(previousCookie);else
previousCookie="";var __cookie=JoinCookies(previousCookie,sCookie);return EscapeCookie(__cookie);}
...
try{window.open=_ASProxy.WindowOpen;}catch(e){}
try{document.open=_ASProxy.WindowOpen;}catch(e){}
try{open=_ASProxy.WindowOpen;}catch(e){}
try{window.location.replace=_ASProxy.LocationReplace;}catch(e){}
try{location.replace=_ASProxy.LocationReplace;}catch(e){}
try{document.write=_ASProxy.DocumentWrite;}catch(e){}
try{document.writeln=_ASProxy.DocumentWriteLn;}catch(e){}}
