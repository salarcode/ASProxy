...
<li class="first"><a asproxydone="2" href="." accesskey="1"><asp:Literal ID="mnuHome" EnableViewState="False" runat="server" meta:resourcekey="mnuHome"
...
<li><a asproxydone="2" href="download.aspx" accesskey="3"><asp:Literal ID="mnuDownload" EnableViewState="False" runat="server" meta:resourcekey="mnuDownload"
...
<asp:Literal ID="lblUrl" EnableViewState="False" runat="server" 
meta:resourcekey="lblUrl" Text="Enter URL:"></asp:Literal>
<br /><asp:TextBox ID="txtUrl" CssClass="urlText" onkeydown="_Page_HandleTextKey(event)"
runat="server" Columns="70" dir="ltr" Width="550px" meta:resourcekey="txtUrl"></asp:TextBox>
<asp:Button CssClass="button" ID="btnASProxyDisplayButton" runat="server" OnClick="btnDisplay_Click"
Text="Display" meta:resourcekey="btnASProxyDisplayButton" />
</div><div class="about"><h1 class="title">
<asp:Label ID="lblMainTitle" runat="server" EnableViewState="False"
meta:resourcekey="lblMainTitle">What is ASProxy?</asp:Label>
</h1><div class="entry">
...
</td><td class="desc"><asp:Literal ID="lblDisplayImages" runat="server" 
meta:resourcekey="lblDisplayImages" Text="Displays images."></asp:Literal>						
</td></tr><tr class="option"><td class="name"><asp:CheckBox ID="chkCompression" runat="server" Text="Compress response" meta:resourcekey="chkCompression" />
</td><td class="desc"><asp:Literal ID="lblCompression" EnableViewState="False" runat="server" 
meta:resourcekey="lblCompression" Text="Compresses the responded page.&lt;br /&gt;This is a recommended option but it is not compatible with all hosting servers."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkRemoveScripts" runat="server" Text="Remove Scripts" Checked="True"
meta:resourcekey="chkRemoveScripts" />
</td><td class="desc">
...
meta:resourcekey="lblUTF8" Text="Uses UTF-8 encoding for pages.&lt;br /&gt;Suitable for non-English sites that contains non-ASCII characters."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkCookies" runat="server" Text="Cookies" Checked="True" 
meta:resourcekey="chkCookies" /></td><td class="desc">
<asp:Literal ID="lblCookies" EnableViewState="False" runat="server" 
meta:resourcekey="lblCookies" Text="Enables cookie support."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkTempCookies" runat="server" Text="Save Cookies as Temp" 
meta:resourcekey="chkTempCookies" /></td><td class="desc">
<asp:Literal ID="lblTempCookies" EnableViewState="False" runat="server" 
meta:resourcekey="lblTempCookies" Text="Saves cookies only for current session, and they will not be available after browser is closed."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkProcessLinks" runat="server" Text="Links" Checked="True" 
meta:resourcekey="chkProcessLinks" /></td><td class="desc">
<asp:Literal ID="lblProcessLinks" EnableViewState="False" runat="server" 
meta:resourcekey="lblProcessLinks" Text="
Processes links and encodes them."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkPageTitle" runat="server" Text="Display page title" Checked="True"
meta:resourcekey="chkPageTitle" />
</td><td class="desc">
<asp:Literal ID="lblPageTitle" EnableViewState="False" runat="server" 
meta:resourcekey="lblPageTitle" Text="Displays page title in browser title."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkForms" runat="server" Text="Process forms" Checked="True" 
meta:resourcekey="chkForms" />
</td><td class="desc"><asp:Literal ID="lblForms" EnableViewState="False" runat="server" 
meta:resourcekey="lblForms" Text="Processes submit forms."></asp:Literal>
</td></tr><tr class="option"><td class="name">
<asp:CheckBox ID="chkFrames" runat="server" Text="Frames" Checked="True" 
meta:resourcekey="chkFrames" />
</td><td class="desc">
<asp:Literal ID="lblFrames" EnableViewState="False" runat="server" 
meta:resourcekey="lblFrames" Text="Enables inline frames."></asp:Literal>
</td></tr></table>
</div></div>
