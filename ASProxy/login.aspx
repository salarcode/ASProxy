...
<asp:Login style="margin:0 auto;" ID="aspLogin" Width="350px" runat="server" OnAuthenticate="aspLogin_Authenticate"
	...
	TitleText="[PageHeader]" BorderPadding="4" Font-Names="Verdana" Font-Size="0.8em"
	ForeColor="#333333" FailureText="[LoginFailed]" LoginButtonText="[LogIn]" PasswordLabelText="[Password]"
	PasswordRequiredErrorMessage="[PasswordRequired]" RememberMeText="[RememberMe]"
	UserNameLabelText="[UserName]" UserNameRequiredErrorMessage="[UserNameRequired]">
